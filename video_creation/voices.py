...
def save_text_to_mp3(reddit_obj) -> Tuple[float, list[int], List[List[float]]]:
    ...
    text_to_mp3 = TTSEngine(
        get_case_insensitive_key_value(TTSProviders, voice),
        reddit_obj,
        max_length=settings.config["settings"]["len"],
    )
